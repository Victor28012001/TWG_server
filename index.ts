...
const config = {
    ...
    redirectUrl: process.env.REDIRECT_URL || `https://toz-ctj2.vercel.app/auth/callback`,
    postLogoutRedirectUrl: process.env.POST_LOGOUT_URL || `https://toz-ctj2.vercel.app/`,
};
